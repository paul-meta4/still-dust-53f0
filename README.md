...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/still-dust-53f0
```

A live public deployment of this template is available at [https://still-dust-53f0.templates.workers.dev](https://still-dust-53f0.templates.workers.dev)
